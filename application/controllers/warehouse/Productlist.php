...
// add new for handle image ==========================
// Function to generate the resized image URL
private function resizeImageUrl($productImage)
{
    $base_url = base_url();
    return $base_url . 'resize_image.php?image=' . $productImage;
}
...
//      // Output the value of $base_url to the browser's console
// echo '<script>console.log("' . $base_url . '");</script>';

//     // Get the product image URL from the model
//     $product_image = $this->productlist_model->Get($data);

//     // Generate the resized image URL using the base URL and product image path
//     $resized_image_url = $base_url . '/resize_image.php?image=' . $product_image;

//     // Return the resized image URL as JSON response
//     $response = array(

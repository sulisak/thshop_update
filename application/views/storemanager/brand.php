                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <form class="form-inline">
                                <img ng-if="x.owner_logo != ''" ng-src="<?php echo $base_url;?>/{{x.owner_logo}}"
                                    style="height: 50px;">


                                <button class="btn btn-info"
                                    ng-click="Updatelogomodal(x)"><?php echo $lang_smb_1;?></button>
                    ...
                    <tr>
                        <td>
                            <button class="btn btn-success btn-lg"
                                ng-click="Updatefooter_slip(x)"><?php echo $lang_save;?></button>
                    ...
                    <tr>
                        ...
                        <td colspan="6" style="text-align: center;">
                            ...
                            <hr />
                            <img class="img" ng-if="x.owner_bgimg != ''"
                                ng-src="<?php echo $base_url;?>/{{x.owner_bgimg}}" style="max-width: 300px;">
    ...
    <div class="panel panel-default col-md-12">
        <div class="panel-body">
            ...
            <button class="btn btn-primary btn-lg" ng-click="Addbranch()">
                <?php echo $lang_smb_9;?>der</button>
            <br /><br />
            <table id="headerTable" class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr ng-repeat="x in datalist">
                        ...
                        <td>{{x.branch_tel}}</td>
                        <td>
                            <button ng-if="x.branch_id!='1'" class="btn btn-xs btn-warning"
                                ng-click="Editebranch(x)">ແກ້ໄຂ</button>

                        </td>
                        <td>
                            <button ng-show="showdeletcbut" class="btn btn-xs btn-danger"
                                ng-click="Delete(x)">ລົບder</button>
                ...
                <div class="modal-body">
                    ...
                    <fieldset>
                        <div class="form-group">
                            <?=$lang_brandname?>
                            <input class="form-control" placeholder="<?=$lang_brandname?>" ng-model="owner_name"
                                type="text" style="height: 50px;font-size: 20px;">
                        </div>

                        <div class="form-group">
                            <?=$lang_tax?>
                            <input class="form-control" placeholder="<?=$lang_tax?>" ng-model="owner_tax_number"
                                type="text" style="height: 50px;font-size: 20px;">
                        </div>
                        ...
                        <div class="form-group">
                            <?=$lang_address?>
                            <textarea name="owner_address" class="form-control" placeholder="<?=$lang_address?>"
                                ng-model="owner_address" style="height: 70px;font-size: 20px;">
</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <input class="form-control" placeholder="<?=$lang_tel?>" ng-model="tel" type="text"
                                style="height: 50px;font-size: 20px;">
                        </div>


                        <input id="submit" class="btn btn-lg btn-success btn-block" type="submit" ng-click="Addbrand()"
                            value="<?=$lang_addbrand?>" ng-hide="foredit">

                        <input id="submit" class="btn btn-lg btn-success btn-block" type="submit" ng-click="Editbrand()"
                            value="<?=$lang_confirm?>" ng-show="foredit">
                        ...
                        <tr ng-repeat="x in fontfamily_json">
                            <td>
                                <button class="btn btn-success"
                                    ng-click="Selectfontc2m(x)"><?php echo $lang_select;?></button>
                            </td>
                ...
                <div class="modal-body" style="font-size:20px;">
                    ...
                    <table class="table table-hover table-bodered">
                        <tr ng-repeat="x in fontfamily_json">
                            <td>
                                <button class="btn btn-success"
                                    ng-click="Selectfontslip(x)"><?php echo $lang_select;?></button>
                            </td>
                            <td>{{x.fontname}}</td>
                            <td style="font-family: '{{x.fontname}}'"><?php echo $lang_smb_11;?></td>
                        </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" ng-model="branch_name"
                        placeholder="<?php echo $lang_brandname;?>">
                    <br />
                    <textarea class="form-control" ng-model="branch_address"
                        placeholder="<?php echo $lang_address;?>"></textarea>
                    <br />

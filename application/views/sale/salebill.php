...
<?=$lang_search?> <?php echo $lang_sb_1;?>" ng-change="getlist(searchtext,'1',perpage)" style="width:300px;">
                ...
                <div class="form-group">
                    <button type="submit" ng-click="getlist(searchtext,'1',perpage)" class="btn btn-success"
                ...
                <div class="form-group">
                    <select ng-model="showall" ng-change="getlist(searchtext,'1',perpage)" class="form-control"
                        style="color:green;">
                ...
                <table id="headerTable" class="table table-hover table-bordered">
                    ...
                    <tbody>
                        <tr ng-repeat="x in list">
                            ...
                            <td>
                                <button ng-if="x.money_changeto_customer !='0.00'" class="btn btn-primary btn-sm"
                                    ng-click="Paypopup(x)"><?=$lang_pay?></button>
                            ...
                            <td>
                                <button ng-if="x.money_from_customer !='0.00'" class="btn btn-info btn-sm"
                                    ng-click="Listpayed(x)">
                            ...
                            <td>
                                ...
                                <button class="btn btn-default btn-sm"
                                    ng-click="Getone(x,'0')">{{x.sale_runno}}</button>



                                <button class="btn btn-default btn-sm"
                                    ng-click="Getone(x,'a4')"><?php echo $lang_sb_14;?></button>
                                <button class="btn btn-default btn-sm"
                                    ng-click="Getone(x,'slip')"><?php echo $lang_sb_15;?></button>
                            ...
                            <td align="right">{{x.sumsale_num | number}}
                                ...
                                <table ng-if="list_detail" style="width:100%;font-size:12px">
                                    ...
                                    <tr ng-repeat="y in list_detail" ng-if="x.sale_runno==y.sale_runno">
                                        ...
                                        <td align="right">
                                            {{(y.product_price-y.product_price_discount)*y.product_sale_num | number}}
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td style="color: red;" align="right">
                                <span style="color:green;"
                                    ng-if="x.money_changeto_customer =='0.00'">{{x.money_from_customer | number:2}}</span>
                                <span
                                    ng-if="x.money_changeto_customer !='0.00'">{{x.money_from_customer | number:2}}</span>
                            ...
                            <td style="color: red;font-weight:bold; " align="right">
                                <span style="color:green;"
                                    ng-if="x.money_changeto_customer =='0.00'">{{x.money_changeto_customer | number:2}}</span>
                                <span
                                    ng-if="x.money_changeto_customer !='0.00'">{{x.money_changeto_customer | number:2}}</span>
                            ...
                            <td>{{x.date_for_pay}}<br />
                                ...
                                <div ng-if="x.money_changeto_customer !='0.00'">
                                    <span style="color:orange;font-weight:bold;"
                                        ng-if="(x.date_for_pay_timestamp-timenow)/86400 > '1'">
                                        <?php echo $lang_sb_16;?>
                                        {{(x.date_for_pay_timestamp-timenow)/86400 | number:0}} <?php echo $lang_date;?>
                                    </span>
                                    <span style="color:blue;font-weight:bold;"
                                        ng-if="x.date_for_pay== datenow && (x.date_for_pay_timestamp-timenow)/86400 > '-0'">
                                        <?php echo $lang_sb_17;?>
                                    </span>
                                    <span style="color:red;font-weight:bold;"
                                        ng-if="(x.date_for_pay_timestamp-timenow)/86400 < '-0'">
                                        <?php echo $lang_sb_18;?>
                                        {{(x.date_for_pay_timestamp-timenow)/86400 | number:0}} <?php echo $lang_date;?>
                                    </span>
                            ...
                            <td ng-if="showdeletcbut" align="center"><button class="btn btn-xs btn-danger"
                        ...
                        <tr>
                            ...
                            <td align="right" style="color: red;font-weight:bold; ">
                                <b>{{Summoney_changeto_customerall() | number:2}}</b></td>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr ng-repeat="x in listone">
                                        ...
                                        <td align="right" style="width:50px;">{{x.product_price_discount | number:2}}
                                        </td>
...
?>
                                    <tr>
                                        ...
                                        <td style="font-weight: bold;" align="right">
                                            {{sumsalevat-((sumsalevat*100)/<?php echo $_SESSION['owner_vat']+100; ?>) | number:2}}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="right" colspan="6"><?=$lang_discount?></td>
                                        <td style="font-weight: bold;" align="right">{{discount_last2 | number:2}}</td>
                                    </tr>
                                    <tr>
                                        <td align="right" colspan="6"><?php echo $lang_all;?></td>
                                        <td style="font-weight: bold;" align="right">
                                            <u>{{sumsalevat-discount_last2 | number:2}}</u></td>
                                    </tr>

                                    <tr>
                                        <td align="right" colspan="6"><?php echo $lang_sb_20;?></td>
                                        <td style="font-weight: bold;" align="right">
                                            <u>{{money_changeto_customer | number:2}}</u></td>
                                    </tr>
...
?>
                                    ...
                                    <tr ng-if="discount_last2 !='0.00'" style="font-weight: bold;">
                                    ...
                                    <tr>
                                        <td align="right" colspan="6"><?php echo $lang_sb_24;?></td>
                                        <td style="font-weight: bold;" align="right">
                                            <u>{{money_from_customer3 | number:2}}</u></td>
                                    </tr>


                                    <tr>
                                        <td align="right" colspan="6"><?php echo $lang_sb_25;?></td>
                                        <td style="font-weight: bold;" align="right">
                                            <u>{{money_changeto_customer | number:2}}</u></td>
                                    </tr>
...
?>
	...
	?>
                                ...
                                <h3> <?php echo $lang_sb_28;?> <br /><b> {{money_changeto_customer | number:2}}</b>
                                </h3>
                            ...
                            <table width="100%">
                                ...
                                <tr ng-if="discount_last2 !='0.00'">
                                    <td align="right"><?=$lang_discount?></td>
                                    <td style="font-weight: bold;" align="right">{{discount_last2 | number:2}}</td>
                                </tr>
                                <tr ng-if="discount_last2 !='0.00'" style="font-weight: bold;">
                                    <td align="right">
                                ...
                                <tr>
                                    <td align="right"><?php echo $lang_sb_24;?></td>
                                    <td style="font-weight: bold;" align="right">
                                        <u>{{money_from_customer3 | number:2}}</u></td>
                                </tr>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" ng-change="Opencusfind()"
                                placeholder="<?php echo $lang_search;?>" ng-model="searchcusname" style="width:200px;">
                                    ...
                                    <tr ng-repeat="x in listcusname" style="font-size:20px;">
                                        <td width="50px" align="center">
                                            <button class="btn btn-primary btn-lg"
                                                ng-click="Openprintbycus(x)"><?php echo $lang_sb_35;?></button>
                                        </td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <span ng-show="paymore=='1'">
                                <center>
                                    <h3><b><?php echo $lang_sb_37;?></b></h3>
                                    <input type="text" onkeypress="validate(event)" id="paymoneymore" name="" value=""
                                        ng-model="paymoneymore" placeholder="จำนวนเงินที่ชำระ" class="form-control"
                                        style="text-align: center;width: 250px;font-size: 26px;height: 50px;background-color: #ffa50069;">
                                    <br />
                                    <button ng-if="paymoneymore!='' && Funcfloat(money_changeto_customer)+Funcfloat(paymoneymore)>money_changeto_customer 
&& Funcfloat(money_changeto_customer)+Funcfloat(paymoneymore)<='0'" class="btn btn-success btn-lg"
                                        ng-click="Payallbill()" ng-disabled="payallbillconfirm=='1'">
...
?>
	...
	?>
                                ...
                                <h3> <?php echo $lang_sb_42;?> <br /><b style="color:red;">
                                        {{money_changeto_customer | number:2}}</b> </h3>

                                <span ng-if="paymore=='1'">
                                    <center>
                                        <h3><b><?php echo $lang_sb_43;?>
                                                <br />
                                                {{paymoneymore}}
                                ...
                                ---------------------------------
                                <br />
                                <input type="checkbox" ng-model="showproduct"
                                    ng-init="showproduct=true"><?=$lang_productservice?>
...
?>
                                    ...
                                    <tr>
                                        <td align="right" colspan="6"><?php echo $lang_sb_47;?></td>
                                        <td style="font-weight: bold;" align="right">
                                            <u>{{money_changeto_customer*-1 | number:2}}</u></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="width: 50%;">
                                            <center> <b><?php echo $lang_sb_48;?></b>
                                                ...
                                                <?php echo $lang_sb_49;?>
                                                <br />
                                                <?php echo $lang_sb_50;?> <?php echo date('d/m/Y',time()); ?>
                                            </center>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center>
                                ...
                                <?=$lang_oksumall?>
                                <br /> <span
                                    style="color: red;font-weight: bold;font-size: 40px;">{{dataall.money_changeto_customer | number:2}}
                                </span>
                                <br />

                                <select class="form-control" ng-model="pay_type"
                                    style="font-size:30px;font-weight:bold;width:200px;height: 60px;">
                                    <option value="1"><?php echo $lang_sb_54;?></option>
                                    <option value="2"><?php echo $lang_sb_55;?></option>
                                </select>
                                <br />

                                <input type="hidden" id="money_from_customer_id" ng-model="money_from_customer_x"
                                    class="form-control"
                                    style="text-align: right;width: 150px;font-size: 26px;height: 50px;background-color: #dff0d8;">

                                <input placeholder="<?php echo $lang_sb_56;?>" type="number" ng-model="pay_money"
                                    class="form-control"
                                    style="text-align: right;width: 250px;font-size: 26px;height: 50px;background-color: #ffa50069;">
                                <br />
                                <input placeholder="<?php echo $lang_sb_57;?>" id="pay_date" type="text"
                                    ng-model="pay_date" class="form-control"
                                    style="text-align: right;width: 350px;font-size: 26px;height: 50px;background-color: #dff0d8;">

                                <br />

                                <textarea class="form-control" ng-model="des"
                                    placeholder="<?php echo $lang_sb_58;?>"></textarea>
                                <br />

                                <button ng-if="pay_money !='' && pay_date !='' && showbb" type="button"
                                    class="btn btn-success btn-lg"
                                    ng-click="Savebill(dataall)"><?=$lang_getmoney?></button>
                            </center>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="openprint_table">
                            <center>
                                ...
                                <br />
                                <span
                                    style="color: blue;font-weight: bold;font-size: 20px;">{{listpp.sumsale_price | number:2}}
                                </span>
                                <br />
                                --------------
                                <br />
                                <?=$lang_oksumall?>
                                <br /> <span
                                    style="color: red;font-weight: bold;font-size: 20px;">{{listpp.money_changeto_customer | number:2}}
                                </span>
                                <br />
                                --------------
                                <br />
...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><b>{{dataall.money_changeto_customer | number:2 }}</b></td>
                                    </tr>

                                    <tr>
                                        <td><?php echo $lang_sb_70;?></td>
                                        <td align="right"><b>{{pay_money | number:2 }}</b></td>
                                    </tr>

                                    <tr>
                                        <td><?php echo $lang_sb_71;?></td>
                                        <td align="right">
                                            <b>{{ParsefloatFunc(pay_money)+ParsefloatFunc(dataall.money_changeto_customer) | number:2 }}</b>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            <b>{{ParsefloatFunc(dataall.money_from_customer)+ParsefloatFunc(pay_money) | number:2 }}</b>
                                        </td>
                                    </tr>

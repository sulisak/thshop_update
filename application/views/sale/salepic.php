...
<input type="checkbox" ng-model="reserv" ng-true-value="1" ng-false-value="0" style="height: 35px;width: 35px;"><?= $lang_bookitem ?>
            ...
            <div style="height: 760px;overflow: auto;">
                ...
                <div <?php if (isset($_GET['mode'])) { ?>
                    ...
                    style="height: 220px;cursor: pointer;padding-left: 0px;padding-right: 0px;"
                                    ...
                                    <tr ng-repeat="x in listsale" style="background-color:#eee;font-size:18px;">
                                        ...
                                        <td style="text-align:left;" class="ng-binding">
                                            ...
                                            <input type="text" onkeypress="validate(event)"
                                                ng-model="x.product_sale_num" ng-change="Updateproductnumber(x,$index)"
                                        ...
                                        <td>
                                            ...
                                            (<input type="text" onkeypress="validate(event)" ng-model="x.product_price"
                                                ng-change="Updateproductprice(x)"
                                            ...
                                            <tbody>
                                                <tr ng-repeat="x in productranklist" ng-if="x.product_rank=='0'">
                                                    <th><button class="btn btn-success btn-xs"
                                                            ng-click="Addproductranksave(x)">+ <?= $lang_add ?></button>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="x in product_point_list">
                                                    ...
                                                    <th><button ng-if="x.point_use <= ParsefloatFunc(customer_score)"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal"
                                            aria-hidden="true">&times;</button>
                                        <h4 class="modal-title"><?php echo $lang_sp_25; ?> {{deletelist_x.sale_runno}}
                                        </h4>
                                    </div>
                                    <div class="modal-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="font-size: 50px;font-weight: bold;">
                                                        <span style="color: red">{{Sumsalepricevat() | number }}</span>
                                                        <?= $lang_currency ?>
                                                    </td>
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="x in listsale" style="font-size: 20px;">
                                                        ...
                                                        <td><button class="btn btn-danger"
                                                                ng-click="Deletepush($index)">ลบ</button></td>
                                                    </tr>
                            ...
                            <div class="modal-body" ng-if="quo_type=='2'" id="openprint2">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            {{sumsale_price | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
                                    </tr>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="x in listone">
                                            ...
                                            <td align="right" style="width:50px;">{{x.product_price_discount | number}}
                                            </td>
                                            <td align="right" style="width:5px;">{{x.product_sale_num | number}}</td>
                                            <td align="right">{{x.product_unit_name}}</td>
                                ...
                                <table ng-if="lung=='2'" class="table table-bordered" width="100%">
                                    <tr>
                                        <td width="50%">
                                            ...
                                            <br />
                                            <span style="font-size: 20px;"><b> <?php echo $_SESSION['owner_name']; ?>
                                                </b>
                                                <br />
                                                <?php echo $_SESSION['owner_address']; ?>
                                                <br />
                                ...
                                <table ng-if="lung=='1'" class="table table-bordered" width="100%">
                                    <tr>
                                        <td align="center">
                                            ...
                                            <br />
                                            <span style="font-size: 30px;"><b> <?php echo $_SESSION['owner_name']; ?>
                                                </b>
                                                <br />
                                                <?php echo $_SESSION['owner_address']; ?>
                                                <br />
...
<br />' . $lang_endstart . ' ( ' . $moneyshiftchange . ' )';
                                    ...
                                    <center>..............................
                                        <br />
                                        <input type="checkbox"
                                            ng-model="hideproduct_shift"><b><?php echo $lang_sp_79; ?> </b>
                                    </center>
                            ...
                            <div class="modal-body">
                                ...
                                <center>
                                    ...
                                    <input type="password" placeholder="<?php echo $lang_sp_114; ?>"
                                        ng-model="orderpass" class="form-control" style="height:50px;font-size50px;">
                                    <br />
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="x in list">
                                                            ...
                                                            <td>
                                                                ...
                                                                <button ng-show="printer_ul !='0'"
                                                                    class="btn btn-primary btn-sm"
                                                                    ng-click="printDivminiip2(x)">พิมพ์สลิป</button>
                                                            ...
                                                            <td ng-show="showdeletcbut" align="center">
                                                                ...
                                                                <button
                                                                    title="<?php echo $lang_sp_123; ?>  {{x.sale_runno}}"
                                    ...
                                    $scope.Updateproductnumber = function(x, index) {
                                        ...
                                        $http.post("Salepic/updateproductnumber", {
                                            ...
                                            if (data.cansale == '0') {
                                                $scope.listsale = data.list;
                                                toastr.warning(
                                                    'ບໍ່ສາມາດສ້າງການຂາຍໄດ້ ເນື່ອງຈາກຕັ້ງຄ່າບໍ່ໃຫ້ຂາຍຖ້າສະຕັອກເຫຼືອນ້ອຍກວ່າທີ່ກຳໜົດ'
                                                );
                                            }

		...
		<?php } else { ?>
			...
			<div style="overflow: auto;">
				...
				<div class="form-group" style="float: left;">
					<input id="product_name_search" ng-model="product_name_search" class="form-control" placeholder=" <?php echo $lang_searchname; ?> <?php echo $lang_productname; ?> <?php echo $lang_barcode; ?>" style="height: 45px;width: 300px;font-size: 20px;" ng-change="pregetlist()">


				</div>
				<a href="<?php echo $base_url; ?>/home/showcus2mer" class="btn btn-warning btn-lg" onclick="window.open(this.href, 'windowName', 'width=1300, height=700, left=24, top=24, scrollbars, resizable'); return false;">ກົດຈໍລູກຄ້າ</a>


				<?php if ($_SESSION['have_product_course'] == '1') { ?>
					<div class="form-group" style="float: left;">
						<button ng-click="Opencourse()" class="btn btn-success btn-lg" placeholder="" title="<?= $lang_search ?>">
...
<input id="customer_name" ng-model="customer_name" class="form-control" placeholder="<?= $lang_cusname ?>" style="height: 45px;width: 110px;font-size: 14px;" readonly="">
					...
					<div class="form-group">
						<button type="submit" ng-click="Opencustomer()" class="btn btn-success btn-lg" placeholder="" title="<?= $lang_search ?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>

							<span ng-if="customer_name ==''"><?= $lang_cusname ?></span>
							<span ng-if="customer_name !=''">{{customer_name}} </span>
						</button>

						<div class="form-group" style="float: right;" ng-if="customer_score && customer_score!='0.00'">

							<button class="btn btn-lg btn-info" style="font-weight:bold" ng-click="Showproduct_pointmodal()">
...
<button ng-click="Refresh()" class="btn btn-default btn-lg" placeholder="" title="<?= $lang_refresh ?>"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
					...
					<a href="<?php echo $base_url; ?>/sale/product_return" class="btn btn-default btn-lg" onclick="window.open(this.href, 'windowName', 'width=1300, height=700, left=24, top=24, scrollbars, resizable'); return false;"><?= $lang_productreturn ?></a>

					<a href="<?php echo $base_url; ?>/warehouse/productlist_foranyone" class="btn btn-default btn-lg" onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;"><?= $lang_stock ?></a>
...
<input type="checkbox" ng-model="reserv" ng-true-value="1" ng-false-value="0" style="height: 35px;width: 35px;"><?= $lang_bookitem ?>
			...
			<div style="height: 760px;overflow: auto;">
				...
				<div <?php if (isset($_GET['mode'])) { ?> class="col-xs-3 col-sm-3 col-md-3 panel panel-default product_box product_box_button" <?php } else { ?> class="col-xs-2 col-sm-2 col-md-2 panel panel-default product_box product_box_button" <?php } ?> ng-repeat="x in productlist" title="{{x.product_name}} {{x.product_des}}" style="height: 220px;cursor: pointer;padding-left: 0px;padding-right: 0px;" ng-click="Addpushproductcode(x.product_code)">
					<center style="font-size: 14px;">
						{{x.product_code}} (<b style="color:red;"><?php echo $lang_sp_3; ?> {{x.product_stock_num |number}}</b>)
					</center>
					<div class="panel-body" style="padding: 0px;">
						...
						<center>
							...
							<img ng-if="x.product_image !== ''" src="<?php echo $base_url; ?>/{{x.product_image}}" class="img img-responsive lazy" style="height: 145px;" title="{{ x.product_name }} {{ x.product_des }}">
							...
							<span ng-if="x.product_price_discount!=0.00 && sale_type=='3'" style="color: red;font-weight: bold;">
								{{x.product_price3-x.product_price_discount | number}}
							</span>

							<span ng-if="x.product_price_discount!=0.00 && sale_type=='4'" style="color: red;font-weight: bold;">
								{{x.product_price4-x.product_price_discount | number}}
							</span>

							<span ng-if="x.product_price_discount!=0.00 && sale_type=='5'" style="color: red;font-weight: bold;">
								...
								<td>
									...
									<div class="form-group" style="float: right;">
										...
										<?php if (!isset($arr) || $arr[29]->status == true) { ?>
											<button ng-click="Opencashnow()" class="btn btn-lg btn-default" style="font-weight:bold">
												<?php echo $lang_sp_6; ?> </button>
										<?php } ?>

										<?php if (isset($_SESSION['shift_user_id']) && $_SESSION['user_id'] == $_SESSION['shift_user_id']) { ?>
											<button ng-click="Closeshiftnow()" class="btn btn-lg btn-info" style="font-weight:bold"><?= $lang_closeshif ?> (<?php if (isset($_SESSION['shift_id'])) {
									...
									<form class="form-inline">
										...
										<div class="form-group">
											<button type="submit" ng-click="Addpushproductcode(product_code)" class="btn btn-default btn-lg" ng-disabled="yingbarcode">Enter</button>
										</div>
						...
						<div class="panel-body">
							...
							<center>
								...
								<form class="form-inline">
									...
									<div class="form-group">
										<select class="form-control" ng-model="sale_type" style="background-color:orange;color:#fff;">
											<option value="1">
			...
			<th><?= $lang_delete ?></th>
									...
									<tbody>
										...
										<tr ng-repeat="x in listsale" style="background-color:#eee;font-size:18px;">
											...
											<td>
												...
												<?php if (!isset($arr) || $arr[22]->status == true) { ?>
													(<input type="text" onkeypress="validate(event)" ng-model="x.product_price" ng-change="Updateproductprice(x)" style="width:50px;height: 20px;font-size: 14px;">)
												<?php } ?>
											...
											<td style="width: 1px;">
												...
												<?php if (isset($arr) && $arr[19]->status == false) { ?>
													<button class="btn btn-danger btn-xs" ng-click="Deletepush_pass(x)">x</button>
												<?php } ?>
										...
										<tr style="font-size:20px;">
											...
											<td align="right" style="font-weight: bold;">{{Sumsaleprice() | number }}</td>
											<td></td>
										</tr>
...
<input type="checkbox" ng-model="addvat" ng-change="Addvatcontrol()">
		<?= $lang_vat ?></td>
							...
							<center>
								...
								<div>
									<button ng-if="listsale != ''" id="savequotation" class="btn btn-warning btn-sm" ng-click="Savequotation()">
										<?php echo $lang_sp_14; ?></button>
									<button ng-if="listsale == ''" ng-click="Showquotationlist()" class="btn btn-warning btn-sm">
							...
							<table class="table">
								<tbody>
										...
										<tr>
											<td width="30%">
												...
												<div ng-show="discount_percent=='0'">
													<input ng-change="Summarysale_change()" type="text" onkeypress='validate(event)' class="form-control" ng-model="discount_last" placeholder="<?= $lang_discount_last ?>" style="font-size: 20px;text-align: right;height: 47px;background-color:#dff0d8;">
													<span ng-if="discount_last!='0'" style="font-weight: normal;">{{(discount_last*100)/(Sumsaleprice() + (Sumsaleprice() * vatnumber/100)) | number }} %</span>
												</div>
												<div ng-show="discount_percent=='1'">
													<input ng-change="Summarysale_change()" type="text" onkeypress='validate(event)' class="form-control" ng-model="discount_last_percent" placeholder="<?= $lang_dis ?> %" style="font-size: 20px;text-align: right;height: 47px;background-color:#dff0d8;">
													<span ng-if="discount_last_percent!='0'" style="font-weight: normal;">{{(Sumsaleprice() + (Sumsaleprice() * vatnumber/100))*(discount_last_percent/100) | number }} <?= $lang_currency ?></span>
												</div>
									...
									<tr>
										...
										<td style="font-weight: bold;font-size: 70px;color: red;text-align: center;vertical-align:middle;">
							...
							<table class="table">
								...
								<tbody>
									...
									<?php if (!isset($arr) || $arr[26]->status == true) { ?>
										<tr>
											<td>
												<input type="text" id="saledate" ng-model="saledate" class="form-control" placeholder="<?php echo $lang_sp_17; ?>" autocomplete="off">
											</td>
										</tr>
									<?php } ?>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<input type="text" name="" ng-model="searchproductrank" ng-change="Searchproductranklist(searchproductrank)" placeholder="ຄົ້ນຫາຊື່ສິນຄ້າ" class="form-control">
											<table class="table table-hover">
												<thead>
												...
												<tbody>
													<tr ng-repeat="x in productranklist" ng-if="x.product_rank=='0'">
														<th><button class="btn btn-success btn-xs" ng-click="Addproductranksave(x)">+ <?= $lang_add ?></button>
											...
											<table class="table table-hover">
												...
												<tbody>
													<tr ng-repeat="x in product_point_list">
														...
														<th><button ng-if="x.point_use <= ParsefloatFunc(customer_score)" class="btn btn-success btn-sm" ng-click="Addpushproductcode(x.product_code,x)"><?php echo $lang_sp_21; ?></button></th>
							...
							<div class="modal fade" id="Deletelist_modal">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
											<h4 class="modal-title"><?php echo $lang_sp_25; ?> {{deletelist_x.sale_runno}}</h4>
										</div>
										<div class="modal-body">
											<center style="color:red;">
												<?php echo $lang_sp_26; ?> {{deletelist_x.sale_runno}} <?php echo $lang_sp_27; ?>
												<br />
												<textarea ng-model="whydel" placeholder="<?php echo $lang_sp_28; ?>" class="form-control"></textarea>
												<br />

												<?php if (!isset($arr) || $arr[18]->status == true) { ?>
													<button ng-if="whydel" class="btn btn-success btn-lg" ng-click="Deletelist(deletelist_x)">
												...
												<?php if (isset($arr) && $arr[18]->status == false) { ?>
													...
													<input type="password" class="form-control" ng-model="billpassword" placeholder="<?php echo $lang_sp_30; ?> ">
													<br />
													<button ng-if="whydel" class="btn btn-success btn-lg" ng-click="Deletelist_pass(deletelist_x)">
														<?php echo $lang_sp_29; ?></button>
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<input ng-model="search_quotationlist" type="text" placeholder="ค้นหา..." class="form-control" style="width:200px;">
											<table class="table table-hover table-bordered">
												...
												<tbody>
													<tr ng-repeat="x in quotationlist | filter:search_quotationlist">
														...
														<td>
															<button class="btn btn-primary btn-sm" ng-click="Getonequotation2pay(x)">
																<?php echo $lang_sp_36; ?>
															</button>
														</td>
														<td><button class="btn btn-info btn-sm" ng-click="Getonequotation(x,'1')">
														...
														<td><button class="btn btn-info btn-sm" ng-click="Getonequotation(x,'2')">
														...
														?>
															...
															<td align="right">{{ParsefloatFunc(x.sumsale_price) * (ParsefloatFunc(x.vat)/100) + ParsefloatFunc(x.sumsale_price) | number}}</td>
														<?php
														}
														?>
											...
											<table class="table table-hover">
												...
												<tbody>
													<tr ng-repeat="x in productlist" ng-if="x.product_rank !='0'">
														<th><button class="btn btn-default btn-xs" ng-click="Delproductranksave(x)">- <?= $lang_exdel ?></button></th>
														<th>{{x.product_name}}</th>
														<th>{{x.product_price}}</th>
													</tr>
												</tbody>
													...
													<tr>
														...
														<td align="left">
															<form class="form-inline">
																...
																<div class="form-group">
																	<button ng-click="Refresh()" class="btn btn-default btn-lg" placeholder="" title="refresh"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
																</div>
															</form>

														</td>
														<td style="font-size: 50px;font-weight: bold;">
															<span style="color: red">{{Sumsalepricevat() | number }}</span> <?= $lang_currency ?>
														</td>
												...
												<table class="table table-hover table-bordered">
													...
													<tbody>
														<tr ng-repeat="x in listsale" style="font-size: 20px;">
															...
															<td align="right" style="width: 150px;">{{x.product_price | number}}</td>
															...
															<td style="width: 50px;" align="right">{{(x.product_price - x.product_price_discount) * x.product_sale_num | number }}</td>
											...
											<table class="table table-hover" width="100%">
												<tbody>
													<tr style="font-size: 20px;">
														...
														<td align="right" style="font-weight: bold;"><?= $lang_summary ?> <span style="color: red">{{Sumsalepricevat() | number }}</span> <?= $lang_currency ?></td>
														<td></td>
													</tr>
												</tbody>
											</table>
									...
									<div class="modal-content">
										...
										<div class="modal-body text-center">
											...
											<center>
												...
												<button class="btn btn-primary btn-lg" ng-click="printDivfull()" style="height:100px;font-size: 30px;font-weight: bold;"><?= $lang_billfull ?>(A4)</button>


												<?php if ($_SESSION['show_order_on_slip'] == '1') { ?>
													<br /><br />
													<button ng-show="printer_ul =='0'" class="btn btn-warning btn-lg" style="height:100px;font-size: 30px;font-weight: bold;" ng-click="printDivmini_order()">(Print Order)</button>
											...
											<center>
												<?php echo $lang_sp_39; ?>
												<select class="form-control" ng-model="print_preview" ng-change="Print_preview_save()" style="width:150px;font-size:16px;font-weight:bold;height:50px;">
													<option value="0">
														<?php echo $lang_sp_40; ?>
													</option>
													<option value="1">
...
pregetlistcus()" class="form-control" placeholder="<?php echo $lang_sp_42; ?>" style="height: 45px;width: 300px;font-size: 20px;">
										</div>
									...
									<table class="table table-hover table-bordered">
										...
										<tbody>
											<tr ng-repeat="x in customerlist">
												<td ng-if="getcourse=='0'"><button class="btn btn-success" ng-click="Selectcustomer(x)">
														<?= $lang_select ?>
													</button></td>

												<td ng-if="getcourse=='1'">

													<button ng-if="x.sumcourse >'0'" class="btn btn-info" ng-click="Selectcourse(x)">
														<?php echo $lang_sp_46; ?> {{x.sumcourse | number}} <?php echo $lang_sp_47; ?>
													</button>
												</td>
												...
												<td><b style="font-size:20px;">{{x.cus_name}}</b>
													<span ng-if="x.credit_limit !='0'">
														<br />
														<b style="color:green;" ng-if="x.credit_limit_foruse !='' && x.credit_limit_foruse >'0.00'">
															<?php echo $lang_sp_48; ?> {{x.credit_limit_foruse | number}}</b>

														<b style="color:red;" ng-if="x.credit_limit_foruse !='' && x.credit_limit_foruse <='0.00'">
															<?php echo $lang_sp_48; ?> {{x.credit_limit_foruse | number}}</b>
										...
										<tbody>
											<tr ng-repeat="x in cuscourselist">
												<td align="center">
													...
													<form ng-if="x.product_sale_num!=x.used_course_num" class="form-inline">
														<div class="form-group">

															<input type="text" onkeypress="validate(event)" style="height:45px;font-size:25px;width:100px;" class="form-control" ng-model="x.use_course" placeholder="<?php echo $lang_qty; ?>">
														</div>
														<div class="form-group">

															<button class="btn btn-success btn-lg" ng-if="x.use_course && x.use_course!='' && x.use_course>'0' && x.use_course<=x.product_sale_num-x.used_course_num" ng-click="Savethiscuscourse(x)">
																<?php echo $lang_sp_56; ?>
															</button>
														</div>
													...
													<span class="badge" style="font-size:20px;" ng-if="x.product_sale_num==x.used_course_num">
												...
												<td align="center">{{x.product_sale_num-x.used_course_num | number}} </td>
											</tr>
										</tbody>
									</table>
								...
								<div class="modal-body" id="openprint1">
									<center>
										...
										<?php if ($_SESSION['owner_tax_number'] != '') {
											echo '<br />' . $lang_tax; ?>:<?php echo $_SESSION['owner_tax_number'];
																																								} ?>
										...
										<tr>
											<td colspan="2">
												...
												<span ng-if="cus_name != null">
													<br /><?= $lang_cusname ?>: {{cus_name}} , <?= $lang_address ?>: {{cus_address_all}}
													<span ng-if="taxnumber!=''"><br /><?php echo $lang_sp_59; ?> {{taxnumber}} </span>
									...
									<table class="table table-hover table-bordered">
										...
										<tbody>
											<tr ng-repeat="x in listone">
												...
												<td align="right" style="width:50px;">{{x.product_price | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
		...
		{{sumsalevat | number}}</td>
											...
											?>
												<tr ng-if="vat3!='0'">
													...
													<td style="font-weight: bold;" align="right">
														{{sumsalevat-sumsale_price | number}}
													</td>
												</tr>
												...
												<tr ng-if="vat3!='0'">
													...
													<td style="font-weight: bold;" align="right">
														{{sumsalevat-(sumsalevat-sumsale_price) | number}}
													</td>
												</tr>
											...
											<tr ng-if="discount_last2 !='0.00'">
												...
												<td style="font-weight: bold;" align="right">-{{discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
											</tr>
											<tr>
												<td align="right" colspan="7"><?= $lang_sumall ?></td>
												<td style="font-weight: bold;" align="right"><u>{{sumsalevat-discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</u></td>
											</tr>


											<tr ng-if="pay_type=='4'">
												<td align="right" colspan="7"><?= $lang_getmoney ?></td>
												<td style="font-weight: bold;" align="right">{{money_from_customer3 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
											</tr>
											...
											?>
												...
												<tr>
													...
													<td style="font-weight: bold;" align="right">
														{{sumsalevat-price_vat_all-discount_last2 | number}}
													</td>
												</tr>
									...
									?>
										...
										<table class="table table-bordered">
											...
											<tr ng-repeat="x in exchangeratelist">
												...
												<td style="font-weight: bold;" align="right">
													{{(sumsalevat-discount_last2)/x.rate | number}}
												</td>
											</tr>
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								<div class="modal-header">
									...
									<select ng-model="quo_type" class="form-control" style="width:200px;float:left;" ng-init="quo_type='1'">
										<option value="1">
											A4
										</option>
										<option value="2">
								...
								<div class="modal-body" ng-if="quo_type=='2'" id="openprint2">
									<center>
										...
										--------------------
										<br />
										<b style="font-size: 20px;font-weight: bold;"> <?php echo $_SESSION['owner_name']; ?> </b>
										<br />
										--------------------
										<br />
										<?= $lang_runno ?>:{{sale_runno}}
										<span ng-if="cus_name!=''"> <br />
											...
											<span ng-if="taxnumber!=''"><br /><?php echo $lang_sp_65; ?> {{taxnumber}} </span>
									...
									<table width="100%">
										<tr ng-repeat="x in listone">
											...
											<td align="right" width="30%">{{(x.product_price - x.product_price_discount) * x.product_sale_num | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
										</tr>
										<tr>
...
<span ng-if="pay_type=='4'" style="font-size: 35px;font-weight: bold;">ใบค้างชำระ</span> -->
	...
	<center style="font-size:100px;font-weight:bold;">{{number_for_cus | number}}</center> -->
									...
									<table class="table table-bordered" style="table-layout: fixed;">
										<tr>
											<td>
												<?= $lang_runno ?>:{{sale_runno}} , <?= $lang_cusname ?>: {{cus_name}} , <?= $lang_address ?>: {{cus_address_all_2}}
									...
									<table class="table table-hover table-bordered">
										...
										<tbody>
											<tr ng-repeat="x in listone">
												...
												<td align="right" style="width:50px;">{{x.product_price | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
												<!-- <td align="right" style="width:50px;">{{x.product_price_discount | number:<?php echo $_SESSION['decimal_print']; ?>}}</td> -->
												<td align="right" style="width:50px;">{{x.product_price_discount | number}}</td>
												<td align="right" style="width:5px;">{{x.product_sale_num | number}}</td>
												<td align="right">{{x.product_unit_name}}</td>
												...
												<td align="right" style="width:50px;">{{(x.product_price - x.product_price_discount) * x.product_sale_num | number:_WWWWW}}</td>
											</tr>
											<tr>
												<td colspan="6" align="right" style="font-weight: bold;">
													<?= $lang_all ?></td>
												...
												<!-- <td align="right" style="font-weight: bold;"><u>{{sumsale_price | number:<?php echo $_SESSION['decimal_print']; ?>}}</u></td> -->
												<td align="right" style="font-weight: bold;"><u>{{sumsale_price | number}}</u></td>
											</tr>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body" style="height:450px;overflow: auto;">
									...
									<div class="col-xs-4 col-sm-4 col-md-4 text-center btn btn-default" ng-repeat="x in getproductpotlist" ng-if="x.show_all=='0'">
										<center>
											<img ng-if="x.product_ot_image!=''" ng-src="<?php echo $base_url ?>/{{x.product_ot_image}}" class="img img-responsive" style="max-height: 83px;" />
										</center>
										<p>
										</p>
										<b>
										...
										<input type="text" onkeypress="validate(event)" ng-model="x.product_ot_price" class="form-control">
										<br />
									...
									<center>
										<?php if ($_SESSION['user_type'] > '0') { ?>
											...
											<?php if (isset($_SESSION['shift_id_old'])) {; ?>
												...
												<button ng-if="printer_ul =='0'" ng-click="Openbillcloseday()" class="btn btn-info btn-lg">
													<?= $lang_printbillshif ?> <?php if (isset($_SESSION['shift_id_old'])) {
																																									echo $_SESSION['shift_id_old'];
																																								} ?></button>

												<button ng-if="printer_ul !='0' " type="button" class="btn btn-info btn-lg" ng-click="Openbillclosedayip()">
													<?= $lang_printbillshif ?> <?php if (isset($_SESSION['shift_id_old'])) {
																																									echo $_SESSION['shift_id_old'];
																																								} ?></button>
											...
											<br />
											<input type="text" onkeypress="validate(event)" class="form-control" style="font-size:20px;font-weight:bold;height:50px;" ng-model="shift_money_start" placeholder="<?php echo $lang_startmoney; ?>" />
											<br>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<center>
										...
										<br />
										<input type="text" onkeypress="validate(event)" class="form-control" style="font-size:17px;font-weight:bold;height:50px;" ng-model="shift_money_end" placeholder="<?php echo $lang_getlastmoney; ?>" />
										<br>
										...
										<form ng-if="addmoneytoshift" action="salepic/addshiftmoneystart" method="post">
											...
											<input type="number" class="form-control" style="font-size:20px;font-weight:bold;height:50px;" name="addshiftmoneystart" placeholder="x.xx" />
											<?php echo $lang_sp_78; ?> <?php if (isset($_SESSION['shift_money_start'])) {
																																							echo number_format($_SESSION['shift_money_start'], 2);
																																						} ?>
											<br>
								...
								<div class="modal-footer">
									...
									<center>
										...
										<button type="button" class="btn btn-default btn-xs" data-dismiss="modal" aria-hidden="true">close</button>
...
<br />' . $lang_endstart . ' ( ' . $moneyshiftchange . ' )';
										...
										<center>..............................
											<br />
											<input type="checkbox" ng-model="hideproduct_shift"><b><?php echo $lang_sp_79; ?> </b>
										</center>
										...
										<table class="table table-bordered">
											...
											<tbody>
												...
												<tr ng-repeat="x in openbillclosedaylistb">
													...
													<td align="right" style="font-weight:bold;">{{x.sumsale_price2-x.discount_last2-x.money_from_customer | number}}</td>
												</tr>
											...
											<tbody>
												<tr ng-repeat="x in openbillclosedaylistc">
													...
													<td align="right" ng-if="x.pay_type=='1'" ng-repeat="y in openbillclosedaylistb">
														{{x.sumsale_price2-y.money_changeto_customer | number}}
													</td>

													<td align="right" ng-if="x.pay_type!='1'">{{x.sumsale_price2 | number}}</td>


												</tr>

												<tr>
													<td width="200px;" align="right" style="font-weight:bold;"><?php echo $lang_sp_83; ?></td>
													<td align="right" style="font-weight:bold;" ng-repeat="y in openbillclosedaylistb">
														{{Summary_pay_type()-y.money_changeto_customer | number}}
													</td>
												</tr>
											...
											<table style="width: 100%;">
												...
												<tbody>
													<tr ng-repeat="x in openbillclosedaylistc">
														...
														<td align="right">{{x.sumsale_price2-x.discount_last2 | number}}</td>
													</tr>
												</tbody>
											</table>
											____________________________________________
													...
													<table width="100%">
														<tr>
															<td width="150px" align="center">
																<img src="<?= $base_url ?>/<?= $_SESSION['owner_logo'] ?>" style="width: 150px;">
															</td>
														</tr>
													</table>
												</center>
 ...
 -->
										...
										<table class="table" style="width: 100%;font-size:14px;">
											...
											<tbody>
												<tr ng-repeat="x in listone">
													...
													<td align="right" width="30px">{{(x.product_price - x.product_price_discount) * x.product_sale_num | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
												</tr>
												<tr>
												...
												<tr ng-if="discount_last2!='0.00'">
													...
													<td align="right">-{{discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
												</tr>

												<tr ng-if="discount_last2!='0.00'">

													<td colspan="3"><?= $lang_sumall ?></td>
													<td align="right" style="font-weight: bold;">{{sumsalevat-discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
												</tr>
												...
												<tr>
													...
													<td align="right">{{money_from_customer3 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
												</tr>
												<tr>
													...
													<td colspan="3">
														...
														<span ng-if="pay_type!='4'" style="font-weight: bold;"><?= $lang_moneychange ?></span>

													</td>
													<td align="right">{{money_from_customer3 -(sumsalevat-discount_last2) | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
												</tr>
										...
										<table width="100%">
											<tr ng-repeat="y in getonepaylist">
												...
												<td align="right">{{y.money | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
							...
							<div class="modal-content">
								...
								<div class="modal-body" style="height:550px;">
									<center>
										...
										<div class="form-group">
											<select class="form-control" ng-model="pay_type" style="background-color:orange;color:#fff;font-size:30px;height:60px;">
												<option ng-repeat="x in pay_type_list" value="{{x.pay_type_id}}">
													{{x.pay_type_name}}
												</option>
											</select>
										</div>
										<input type="text" id="money_from_customer_id" class="form-control" ng-model="money_from_customer" placeholder="<?= $lang_getmoneyfromcus ?>" onkeypress="validate(event)" autocomplete="off" style="text-align: right;height: 70px;background-color:#dff0d8;font-size: 40px;font-weight:bold;" autofocus>


										<br />

										<div ng-click="Addnumbermoney('c2m')" class="col-xs-12 col-sm-12 col-md-12 btn btn-primary" style="font-size:40px;font-weight:bold;height: 70px;">
										...
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_1; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_1_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_2; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_2_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_3; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_3_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_4; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_4_t; ?>
										</div>



										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_5; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_5_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_6; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_6_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_7; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_7_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_8; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_8_t; ?>
										</div>


										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_9; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_9_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_0; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-default" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_0_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_20; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-info" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_20_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_50; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-info" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_50_t; ?>
										</div>


										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_100; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-info" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_100_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_500; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-info" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_500_t; ?>
										</div>
										<div ng-click="Addnumbermoney('<?php echo $lang_sp_98_1000; ?>')" class="col-xs-3 col-sm-3 col-md-3 btn btn-info" style="font-size:40px;font-weight:bold;height: 70px;">
											<?php echo $lang_sp_98_1000_t; ?>
										</div>
										<div ng-click="Addnumbermoney('')" class="col-xs-3 col-sm-3 col-md-3 btn btn-warning" style="font-size:20px;font-weight:bold;height: 70px;">
											x <br /> <?= $lang_deleteall ?>
										</div>
										...
										<div class="col-xs-12 col-sm-12 col-md-12">
											...
											<?php echo $lang_sp_99; ?>
											<textarea placeholder="<?php echo $lang_sp_99; ?>" ng-show="showremark" ng-model="saleremark" class="form-control" style="height:200px;"></textarea>
								...
								<div class="modal-footer">
									...
									<center>
										<button type="button" class="btn btn-danger btn-lg" data-dismiss="modal" aria-hidden="true">ປິດໜ້າຕ່າງ(Esc)</button>
									</center>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<center>
										...
										<span ng-if="popup_pricenum=='3'" style="color:red;"><?php echo $lang_sp_105; ?></span>
										<form class="form-inline">
											<input type="number" id="popup_nummodal_focus" ng-model="popup_num_num" ng-change="Savepopup_num()" class="form-control" style="height: 100px;
    font-size: 100px;
	width: 100%;
    color: green;">
											<br />
											<br />
											<button type="submit" class="btn btn-success btn-lg" data-dismiss="modal" aria-hidden="true">
												Enter
											</button>
										</form>
									</center>
								...
								<div class="modal-footer">
									...
									<center>
										<button type="button" class="btn btn-danger btn-lg" data-dismiss="modal" aria-hidden="true">Close ESC</button>
									</center>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<center style="font-size:30px;">
										...
										:<?php echo $lang_sp_108; ?> <b style="color:green;">{{Summorepaymoney() | number}}</b>
									</center>
									...
									<div ng-repeat="x in pay_type_list" ng-if="x.pay_type_id!='4'">
										{{x.pay_type_name}}
										<input onkeypress="validate(event)" ng-model="x.pay_money" placeholder="{{x.pay_type_name}}" class="form-control" style="color:orange;font-size:30px;height: 50px;">
									</div>
									...
									<div class="col-xs-12 col-sm-12 col-md-12">
										...
										<textarea placeholder="<?php echo $lang_sp_109; ?>" ng-if="showremark" ng-model="saleremark" class="form-control" style="height:200px;"></textarea>
										<span ng-show="showremark">
											<select ng-model="showremarkonslip">
												<option value="0">
									...
									<button ng-if="Summorepaymoney() >= Sumsaleprice() - discount_last && Countmorepaymoney() > '1'" type="submit" class="col-xs-12 col-sm-12 col-md-12 btn btn-success" style="font-size:40px;font-weight:bold;height: 70px;" id="savesalemorepay" ng-click="Savesale(money_from_customer,Sumsalepricevat(),discount_last )">
										<?= $lang_confirm ?>(Enter)
									</button>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<center>
										...
										<form class="form-inline">
											<input type="number" id="popup_pricemodal_focus" ng-model="popup_price_price" ng-change="Savepopup_price()" class="form-control" style="height: 100px;
    font-size: 100px;
	width: 100%;
    color: blue;">
											<br />
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<center>
										...
										<input type="password" placeholder="<?php echo $lang_sp_114; ?>" ng-model="orderpass" class="form-control" style="height:50px;font-size50px;">
										<br />


										<button class="btn btn-success btn-lg" ng-click="Deletepush_pass_ok(deletepushdatax)">
						...
						<div class="modal fade" id="Openoneminiip">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-body">
										<div id="section-to-print-slip" style="width: <?php echo $pt_width; ?>;font-size: 25px;text-align: left;background-color: #fff;overflow:visible !important;">
 ...
 -->
											...
											<table style="width: 100%;font-size: 25px;">
												...
												<tr ng-repeat="x in listone">
													...
													<td align="right" valign="top">{{(x.product_price - x.product_price_discount) * x.product_sale_num | number}}</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td></td>
													<td align="right" style="font-weight: bold;">{{sumsalevat-discount_last2 | number}}</td>
												</tr>
												...
												<tr>
													...
													<td></td>
													<td align="right">{{money_from_customer3 -(sumsalevat-discount_last2) | number}}</td>
												</tr>
											...
											<div class="panel panel-default">
																...
																<tbody>
																	<tr ng-repeat="x in list">
																		...
																		<td>
																			...
																			<button ng-show="printer_ul !='0'" class="btn btn-primary btn-sm" ng-click="printDivminiip2(x)">พิมพ์สลิป</button>
																		...
																		<td>{{x.cus_name}}
																			...
																			<span ng-if="x.product_score_all !='0.00'" style="color:green;font-weight:bold;">
																				+{{x.product_score_all | number}} <?php echo $lang_score; ?> </span>
																		...
																		<td align="right">{{ParsefloatFunc(x.sumsale_price) * (ParsefloatFunc(x.vat)/100) + ParsefloatFunc(x.sumsale_price) - x.discount_last | number}}</td>
																		<td align="right">{{x.money_from_customer | number}}</td>
																		<td align="right">{{x.money_from_customer - ((ParsefloatFunc(x.sumsale_price)  * (ParsefloatFunc(x.vat)/100) + ParsefloatFunc(x.sumsale_price)) - x.discount_last) | number}}</td>
																		...
																		<td>
																			...
																			<span ng-if="x.cmp>'1'">
																				<button class="btn btn-info btn-xs" ng-click="Seemorepay(x)">{{x.cmp}}
												...
												<script>
													...
													app.controller('Index', function($scope, $http, $location) {
														...
														// 	console.log('this is getLazyImageSource ....', $scope.base_url + '/' + productImage)
														...
														$(window).keydown(function(event) {
															if (event.keyCode == 32) {
																...
																console.log('SpaceBar was pressed to open model money');
															...
															if (event.keyCode == 13) {
																...
																if ($scope.Summorepaymoney() >= $scope.Sumsaleprice() - $scope.discount_last && $scope.Countmorepaymoney() > '1') {
														...
														$scope.Getnumtoprice = function(x) {
															...
															$http.post("<?php echo $base_url; ?>/salesetting/numtoprice/getproductbuy", {
																'product_code': x

															}).success(function(data) {

																if (data.length > 0) {
																	var discount_numtoprice = Math.floor(data[0].product_sale_num / data[0].num) * ((data[0].product_price * data[0].num) - data[0].price);


																	if (data[0].remark != '' && data[0].product_sale_num == 1) {
																		$scope.getnumtoprice_noti = data[0].remark;
																		$('#Modalgetnumtoprice_noti').modal('show');
																		setTimeout(function() {
																			$('#Modalgetnumtoprice_noti').modal('hide');
																		}, 3000);
																	}
																	...
																	} else if (data[0].product_sale_num / data[0].num == 2) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - ((data[0].product_price * data[0].num) - data[0].price);
																	} else if (data[0].product_sale_num / data[0].num == 3) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (2 * ((data[0].product_price * data[0].num) - data[0].price));
																	} else if (data[0].product_sale_num / data[0].num == 4) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (3 * ((data[0].product_price * data[0].num) - data[0].price));
																	} else if (data[0].product_sale_num / data[0].num == 5) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (4 * ((data[0].product_price * data[0].num) - data[0].price));
																	} else if (data[0].product_sale_num / data[0].num == 6) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (5 * ((data[0].product_price * data[0].num) - data[0].price));
																	} else if (data[0].product_sale_num / data[0].num == 7) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (6 * ((data[0].product_price * data[0].num) - data[0].price));
																	} else if (data[0].product_sale_num / data[0].num == 8) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (7 * ((data[0].product_price * data[0].num) - data[0].price));
																	} else if (data[0].product_sale_num / data[0].num == 9) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (8 * ((data[0].product_price * data[0].num) - data[0].price));
																	} else if (data[0].product_sale_num / data[0].num == 10) {
																		$scope.discount_last = discount_numtoprice + parseFloat($scope.discount_last) - (9 * ((data[0].product_price * data[0].num) - data[0].price));
																	}
														...
														$scope.Getnumtoprice_3 = function(x) {
															...
															$http.post("<?php echo $base_url; ?>/salesetting/numtoprice/getproductbuy", {
																...
																if (data.length > 0) {
																	var discount_numtoprice = Math.floor(data[0].product_sale_num / data[0].num) * ((data[0].product_price * data[0].num) - data[0].price);
																	$scope.discount_last = parseFloat($scope.discount_last) - discount_numtoprice;
														...
														$scope.Getround = function() {
															$http.post("<?php echo $base_url; ?>/salesetting/round_setting/getround", {}).success(function(data) {
														...
														$scope.Getpointtomoney = function() {
															...
															$http.get('<?php echo $base_url; ?>/salesetting/setting_etc/getpointtomoney')
																.then(function(response) {
														...
														$scope.Get_stock_rule = function() {
															...
															$http.get('<?php echo $base_url; ?>/salesetting/setting_etc/get_stock_rule')
																.then(function(response) {
														...
														$scope.Discount_lastfunc = function() {
															...
															if ($scope.discountfrombuylist && $scope.discountfrombuylist.money_will_discount != '0') {
																$scope.discount_last = Math.floor(Math.floor(parseFloat(total3) / parseFloat($scope.discountfrombuylist.money_if)) * parseFloat($scope.discountfrombuylist.money_will_discount));
																$scope.discount_money = Math.floor(Math.floor(parseFloat(total3) / parseFloat($scope.discountfrombuylist.money_if)) * parseFloat($scope.discountfrombuylist.money_will_discount));
														...
														$scope.Discount_lastfunc2 = function() {
															...
															if ($scope.pointtomoney && $scope.pointtomoney.money_will != '0' && $scope.customer_score && $scope.total3 > '0') {

																$scope.discount_last = Math.floor(Math.floor(parseFloat($scope.customer_score) / parseFloat($scope.pointtomoney.cus_point_if)) * parseFloat($scope.pointtomoney.money_will) + Math.floor(Math.floor(parseFloat($scope.total3) / parseFloat($scope.discountfrombuylist.money_if)) * parseFloat($scope.discountfrombuylist.money_will_discount)));
																...
																$scope.customer_usepoint = Math.floor(Math.floor(parseFloat($scope.discount_last - $scope.discount_money) / parseFloat($scope.pointtomoney.money_will)) * parseFloat($scope.pointtomoney.cus_point_if));
														...
														$scope.Getpotmodal = function(x, index) {
															...
															$scope.potdata = x;
															$http.post("<?php echo $base_url; ?>/warehouse/Productlist/getpotlist2", {
																product_id: x.product_id
															}).success(function(data) {
														...
														$scope.getpotall = function() {
															...
															$http.get('<?php echo $base_url; ?>/warehouse/Productlist/getpotall2')
																.then(function(response) {
														...
														$scope.Selectcustomer = function(x) {
															...
															$scope.customer_group_discountpercent = x.customer_group_discountpercent;
															$scope.cus_address_all = x.cus_address + ' ' + x.cus_address_postcode + ' ' + ' <?php echo $lang_tel; ?>: ' + x.cus_tel;
														...
														$scope.Addpushproductcode = function(product_code, x) {
															...
															$http.post("Salepage/Findproduct", {
																...
																if (data.list != '' && data.list[0].popup_pricenum == '1' || data.list != '' && data.list[0].popup_pricenum == '3') {
																	//แสดง popup ให้ใส่จำนวนเอง
																	$('#popup_nummodal').modal('show');
																	$scope.product_name_popupnum = data.list[0].product_name;
																	$scope.product_price_popupnum = data.list[0].product_price;
																...
																if (data.list != '' && data.list[0].popup_pricenum == '2') {
																...
																if (data == '') {
																	...
																	if (data[0].product_stock_num <= -1000000000000000000000000000000000000000) {
																		...
																		if (data[0].count_stock == 0 && data[0].product_stock_num <= 0) {
																			//toastr.warning('<?= $lang_outofstock ?>');
																		}
																		...
																		if (data[0].product_stock_num > $scope.stock_rule.stock_nosale && $scope.cansale == '1') {
																			...
																			if (x) {
																				...
																				product_price = '0';
																				$scope.customer_score = $scope.customer_score - x.point_use;
																			...
																			if ($scope.sn_code == '') {
																				...
																				psn = data[0].product_name + '(' + $scope.sn_code + ')';
																			}
																			...
																			?>
																				if ($scope.www != '0') {
																					psn = data[0].product_name + '(' + $scope.w_dws + ')';
																				}
																			<?php } ?>

																			if ($scope.customer_group_discountpercent != false) {
																				data[0].product_price_discount = product_price * ($scope.customer_group_discountpercent / 100);
																				data[0].product_price_discount_percent = $scope.customer_group_discountpercent;
																			}
																			...
																			$http.post("Salepic/saveshowcus", {
																				...
																				product_stock_num: data[0].product_stock_num,
																				...
																				$scope.Getnumtoprice($scope.getnumtoprice_product_code);
														...
														$scope.Selectpot = function(x) {
															if (x.product_ot_price == '0') {
																...
																if (x.type == '0') {
																	...
																	pot_price = parseFloat($scope.potdata.product_price) + parseFloat(x.product_ot_price);
																} else if (x.type == '1') {
																	p_name = $scope.potdata.product_name + ' \n (' + x.product_ot_name + ' ' + x.product_ot_price + '%)';
																	pot_price = parseFloat($scope.potdata.product_price) + (parseFloat($scope.potdata.product_price) * parseFloat(x.product_ot_price) / 100);
																} else {
																	p_name = $scope.potdata.product_name + ' \n (' + x.product_ot_name + ' ' + x.product_ot_price + ')';
																	pot_price = parseFloat($scope.potdata.product_price) * parseFloat(x.product_ot_price);;
																}
														...
														$scope.Savesale = function(changemoney, sumsalepricevat, discount_last) {
															...
															if ($scope.listsale == '' || $scope.listsale[0].product_id == '0') {
																...
																$http.post("Salepage/Savesale", {
																	...
																	if ($scope.pay_type == '1' || $scope.pay_type == '4') {
																	...
																	console.error('An error occurred:', error, $scope.listsale);
														...
														$scope.Addnumbermoney = function(x) {
															...
															if (x == 'c2m') {
																if ($scope.discount_percent == '0') {
																	x = $scope.Sumsaleprice() + ($scope.Sumsaleprice() * $scope.vatnumber / 100) - $scope.discount_last;
																} else {
																	x = $scope.Sumsaleprice() + ($scope.Sumsaleprice() * $scope.vatnumber / 100) - (($scope.Sumsaleprice() + ($scope.Sumsaleprice() * $scope.vatnumber / 100)) * ($scope.discount_last_percent / 100))
																}
														...
														$scope.pregetlist = function() {
															...
															setTimeout(function() {
																$scope.searchtextarray2.push($scope.product_name_search);
														...
														$scope.pregetlistcus = function() {
															...
															setTimeout(function() {
																$scope.csearchtextarray2.push($scope.search_customer_name);
														...
														$scope.Checklogin = function() {
															$http.post("<?php echo $base_url; ?>/c2mhelper/checklogin", {}).success(function(response) {
																if (response == '0') {

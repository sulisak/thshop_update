		...
		<div class="panel-body">
			...
			<div class="form-inline">
				...
				<div class="form-group">
					<input type="text" ng-model="searchtext" class="form-control" placeholder="<?= $lang_search ?>  <?php echo $lang_pl_2; ?>" style="width: 350px;" ng-change="pregetlist()">
				</div>
...
<img ng-if="!list" src="<?php echo $base_url; ?>/pic/loading.gif">
					...
					<tbody>
						...
						<tr ng-repeat="x in list">
							...
							<td align="center">
								...
								<a href="<?php echo $base_url; ?>/warehouse/barcode_ds?type=1&product_code={{x.product_code}}&product_price={{x.product_price}}&product_name={{x.product_name}}" class="btn btn-xs btn-default c2mforhide" onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;">
									<span class="glyphicon glyphicon-barcode" aria-hidden="true"></span>
									<?php echo $lang_pl_14; ?> </a>


								<a href="<?php echo $base_url; ?>/warehouse/barcode_ds?type=2&product_code={{x.product_code}}&product_price={{x.product_price}}&product_name={{x.product_name}}" class="btn btn-xs btn-default c2mforhide" onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;">
									<span class="glyphicon glyphicon-barcode" aria-hidden="true"></span>
									QRCODE </a>
			...
			<td align="right" ng-if="show25">{{x.product_price5 | number:2}}</td> -->
							...
							<td align="center">
								...
								<select class="form-control" ng-if="x.popup_pricenum=='3'" ng-change="Update_popup_pricenum(x)" ng-model="x.popup_pricenum" style="width:130px;color:orange;">
									<option value="0" style="color:red;"><?php echo $lang_pl_17; ?></option>
									<option value="1" style="color:green;"><?php echo $lang_pl_18; ?></option>
									<option value="2" style="color:blue;"><?php echo $lang_pl_19; ?></option>
									<option value="3" style="color:orange;"><?php echo $lang_pl_20; ?></option>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="uploadImg" enctype="multipart/form-data" method="POST">
								...
								<input type="hidden" id="product_date_end" name="product_date_end" placeholder="<?php echo $lang_pl_37; ?>" class="form-control">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="Updatedata" enctype="multipart/form-data" method="POST">
								...
								<input type="hidden" name="product_date_end" id="product_date_end2" placeholder="<?php echo $lang_pl_37; ?>" class="form-control">

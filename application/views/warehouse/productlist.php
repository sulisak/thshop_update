            ...
            <div class="form-inline">
                ...
                <div class="form-group">
                    <input type="text" ng-model="searchtext" class="form-control"
                        placeholder="<?= $lang_search ?>  <?php echo $lang_pl_2; ?>" style="width: 350px;"
                        ng-change="pregetlist()">
                </div>
...
<img ng-if="!list" src="<?php echo $base_url; ?>/pic/loading.gif">
			...
			// if(!isset($arr) || $arr[24]->status==true) original have this
                ...
                <table ng-if="list" id="headerTable" class="table table-hover table-bordered" style="font-size: 14px;">
                    <thead>
                        <tr style="background-color: #eee;">
                            ...
                            <?php if ($_SESSION['user_type'] == 4 || $_SESSION['user_type'] == 3) { ?>
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="x in list">
                            ...
                            <td ng-if="selectthispage!='1'" class="text-center">
                                {{($index+1)+(perpage*(selectthispage-1))}}</td>
                            ...
                            <td align="center">
                                ...
                                <a href="<?php echo $base_url; ?>/warehouse/barcode_ds?type=1&product_code={{x.product_code}}&product_price={{x.product_price}}&product_name={{x.product_name}}"
                                    class="btn btn-xs btn-default c2mforhide"
                                ...
                                <a href="<?php echo $base_url; ?>/warehouse/barcode_ds?type=2&product_code={{x.product_code}}&product_price={{x.product_price}}&product_name={{x.product_name}}"
                                    class="btn btn-xs btn-default c2mforhide"
                                    onclick="window.open(this.href, 'windowName', 'width=1000, height=700, left=24, top=24, scrollbars, resizable'); return false;">
                                    <span class="glyphicon glyphicon-barcode" aria-hidden="true"></span>
                                    QRCODE </a>
                                ...
                                <span ng-if="x.product_image!=''">
                                    <center>
                                        <img src="<?php echo $base_url; ?>/{{x.product_image}}"
                                            class="img img-responsive lazy" width="70px" height="70px;">
                                        <br />
                            ...
                            <td>
                                ...
                                <br />
                                <button ng-click="Opensn(x)" class="btn btn-default btn-xs" ng-if="x.csn>'0'">{{x.csn}}
                                    SN</button>
                            ...
                            <td>
                                <center>
                                    ...
                                    <button class="btn btn-warning" ng-click="Updatematmodal(x)"
                                        style="width: 120px;font-size:12pt;font-weigth:bold;">
			...
			<td align="right" ng-if="show25">{{x.product_price5 | number:2}}</td> -->
                            ...
                            <td align="center">
                                ...
                                <select class="form-control" ng-if="x.have_vat=='0'" ng-change="Update_vat(x)"
                                    ng-model="x.have_vat" style="width:73px;color:green;">
                                    <option value="0" style="color:green;"><?php echo $lang_pl_21; ?></option>
                                    <option value="1" style="color:red;"><?php echo $lang_pl_22; ?></option>
                                </select>

                                <select class="form-control" ng-if="x.have_vat=='1'" ng-change="Update_vat(x)"
                                    ng-model="x.have_vat" style="width:73px;color:red;">
                                    <option value="0" style="color:green;"><?php echo $lang_pl_21; ?></option>
                                    <option value="1" style="color:red;"><?php echo $lang_pl_22; ?></option>
                                </select>
                            ...
                            <td>
                                ...
                                <?php
								// if(!isset($arr) || $arr[25]->status==true )  original have here
								if ($_SESSION['user_type'] == 4 || $_SESSION['user_type'] == 3) // this one update for let only admin & vendor stock update quatity stock


								{ ?>
                                <button class="btn btn-xs btn-warning"
                                    ng-click="Editinputproduct(x)"><?= $lang_edit ?></button>
                                <?php } ?>

                                <?php if (!isset($arr) || $arr[24]->status == true) { ?>
                                <button ng-show="showdeletcbut" class="btn btn-xs btn-danger"
                                    ng-click="Deleteproduct(x)"><?= $lang_delete ?>der</button>
            ...
            <hr />
            <button id="btnExport" class="btn btn-default" onclick="fnExcelReport();"> <span
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <center>
                                <h2><?= $lang_num ?></h2>
                                <input type="text" onkeypress="validate_number(event)"
                                    ng-model="product_stock_num_change" class="form-control"
                                    style="font-size: 25px;text-align: center;">
                                <br />

                                <textarea class="form-control" ng-model="log_edit_des"
                                    placeholder="<?php echo $lang_pl_23; ?>"></textarea>
            ...
            <div class="modal fade" id="updatepotmodal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title"><?php echo $lang_pl_5; ?> {{potdata.product_name}} 1
                                {{potdata.product_unit_name}}</h4>
                        </div>
                        <div class="modal-body">
                            <?= $lang_relaydetail ?>
                            <?php echo $lang_pl_24; ?>
                            <input type="text" placeholder="<?php echo $lang_pl_24_a3; ?>" class="form-control"
                                ng-model="search_pot" ng-change="Searchpot(search_pot)">
                            <br />
                            <?php echo $lang_pl_25; ?>
                            <table class="table">
                                <tr ng-repeat="x in getpotlist">
                                    <td><button ng-if="x.product_num_relation" ng-click="Addpot(x)"
                                            class="btn btn-success"><?= $lang_add ?></button></td>

                                    <td>
                                        <select class="form-control" ng-if="x.product_num_relation"
                                            ng-model="x.product_type_relation" ng-init="x.product_type_relation='0'">
                                    ...
                                    <td>
                                        <input type="number" placeholder="จำนวน" ng-model="x.product_num_relation"
                            ...
                            <table class="table">
                                <tr ng-repeat="x in getproductpotlist">
                                    ...
                                    <td><button ng-click="Delpot(x)"
                                            class="btn btn-xs btn-danger"><?= $lang_delete ?></button></td>
                                </tr>
                            </table>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" placeholder="<?php echo $lang_pl_34; ?>" class="form-control"
                                ng-model="search_pot2" ng-change="Searchpot2(search_pot2)">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="uploadImg" enctype="multipart/form-data" method="POST">
                                ...
                                <p></p>
                                <?php echo $lang_pl_38; ?>
                                <input name="product_pricebase" placeholder="<?= $lang_cost ?>"
                                    class="form-control text-right">
                                <?php } else { ?>
                                <input type="hidden" name="product_pricebase" placeholder="<?= $lang_cost ?>"
                                    class="form-control text-right">
                                <?php } ?>
                                ...
                                <?php echo $lang_pl_39; ?>
                                <input type="text" name="product_price" placeholder="<?php echo $lang_pl_8; ?>"
                                    class="form-control text-right">
                                <p></p>

                                <input type="text" name="product_wholesale_price"
                                    placeholder="<?php echo $lang_pl_9; ?>" class="form-control text-right">
                                <p></p>


                                <?= $lang_score ?>
                                <input type="text" name="product_score" placeholder="<?= $lang_score ?>"
                                    class="form-control text-right">
                                ...
                                <p></p>
                                <?= $lang_alertwhennum ?>
                                <input type="text" name="product_num_min" placeholder="0"
                                    class="form-control text-right">
                                ...
                                <br />
                                <?php echo $lang_pl_45; ?>
                                <input type="text" onkeypress="validate_number(event)" name="product_weight"
                                    placeholder="0" class="form-control text-right">
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <?= $lang_productname ?>
                            <input type="text" ng-model="product_name_sizecolor" placeholder="<?= $lang_productname ?>"
                                class="form-control">
                            <p></p>


                            <?php echo $lang_pl_46; ?>
                            <input type="text" ng-model="product_price_sizecolor"
                                placeholder="<?php echo $lang_pl_46; ?>" class="form-control text-right">
                            <p></p>
                                ...
                                <tr>
                                    <td><b><?php echo $lang_pl_47; ?></b>
                                        ...
                                        <span ng-repeat="x in sizelist">
                                            <input ng-click="Addsizelist(x.product_size_name,price)" type="checkbox"
                                                value="1" name="sizename[]">{{x.product_size_name}}<br />
                                        </span>
                                    </td>
                                    <td><b><?php echo $lang_pl_48; ?> </b>
                                        <br />
                                        <span ng-repeat="x in colorlist">
                                            <input ng-click="Addcolorlist(x.product_color_name)" type="checkbox"
                                                value="1" name="colorname[]">{{x.product_color_name}}<br />
                                        </span>
                                    </td>
                        ...
                        <div class="modal-body">
                            <form id="Updatedata" enctype="multipart/form-data" method="POST">
                                ...
                                <center ng-if="product_image!=''">
                                    <img ng-src="<?php echo $base_url; ?>/{{product_image}}" width="70px"
                                        height="70px;">
                                ...
                                <p></p>
                                <?php echo $lang_pl_38; ?>
                                <input name="product_pricebase" id="product_pricebase" placeholder="<?= $lang_cost ?>"
                                    class="form-control text-right">

                                <?php } else { ?>
                                <input type="hidden" name="product_pricebase" id="product_pricebase"
                                    placeholder="<?= $lang_cost ?>" class="form-control text-right">
                                <?php } ?>
                                ...
                                <input type="text" name="product_price" id="product_price"
                                    placeholder="<?php echo $lang_pl_8; ?>" class="form-control text-right">


                                <p></p>
                                <input type="text" name="product_wholesale_price" id="product_wholesale_price"
                                    placeholder="<?php echo $lang_pl_9; ?>" class="form-control text-right">
                                <p></p>
                                <input type="text" name="product_price3" id="product_price3"
                                    placeholder="<?php echo $lang_pl_10; ?>" class="form-control text-right">
                                <p></p>
                                <input type="text" name="product_price4" id="product_price4"
                                    placeholder="<?php echo $lang_pl_11; ?>" class="form-control text-right">
                                <p></p>
                                <input type="text" name="product_price5" id="product_price5"
                                    placeholder="<?php echo $lang_pl_12; ?>" class="form-control text-right">

                                <p></p>
                                <?= $lang_score ?>
                                <input type="text" name="product_score" id="product_score"
                                    placeholder="<?= $lang_score ?>" class="form-control text-right">
                                ...
                                <?= $lang_alertwhennum ?>
                                <input type="text" name="product_num_min" id="product_num_min" placeholder="0"
                                    class="form-control text-right">
                                ...
                                <br />
                                <?php echo $lang_pl_45; ?>
                                <input type="text" onkeypress="validate_number(event)" id="product_weight"
                                    name="product_weight" placeholder="0" class="form-control text-right">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <form enctype="multipart/form-data" id="formexcel">
                                ...
                                <button class="btn btn-success" ng-disabled="uploadexcel=='1'" id="submitexcel"
                                    type="submit"><?= $lang_upload ?></button>
                            </form>

                            <hr />

                            <a class="btn btn-danger" href="<?php echo $base_url; ?>/pic/c2mposproduct.csv"
                                target="_blank">
                            ...
                            <a class="btn btn-primary"
                                href="<?php echo $base_url; ?>/warehouse/productlist/downloadexcel" target="_blank">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == '1') {
                        ...
                        $("#Updatedata")[0].reset();
                        $scope.getlist($scope.searchtext, $scope.selectthispage,
                            $scope.perpage);
                        $('#Openedit').modal('hide');
                        $('#Openeditloading').modal('hide');
                    }
